...
import br.com.zup.beagle.sample.service.*
...
class ScreenController(
    ...
    fun getProductList() = this.accessibilityService.createAccessibilityView()

    @GetMapping("/product/{sku}")
    fun getProductBySku(@PathVariable sku: String) = this.accessibilityService.createProductView(sku)
